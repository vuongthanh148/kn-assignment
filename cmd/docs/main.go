...
const DEFAULT_DEP_PARSED_DEPTH = 100 // default depth for dependency parsing
...
var initFlags = []cli.Flag{
	...
	&cli.IntFlag{
		Name:  parseDepthFlag,
		Value: DEFAULT_DEP_PARSED_DEPTH,
...
func initAction(ctx *cli.Context) error {
	...
	return gen.New().Build(&gen.Config{
		...
		ParseDependency:     ctx.Int(parseDependencyFlag),
